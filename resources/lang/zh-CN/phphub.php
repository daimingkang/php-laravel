...
return [
    ...
    'GitHub Name likes: summerblue' => '如：戴明康',
    ...
    'Weibo Username example: PHPHub' => '如：PHP-Laravel',
    ...
    'Dont have any votes yet' => '还未赞过任何主题',
    ...
    'site_intro' => 'PHP Laravel 中国最大的 PHP 和 laravel 开发者社区',
    'contributing' => '功能正在完善中, 欢迎 <i class="fa fa-github" style="font-size:15px"></i> <a href="https://github.com/daimingkang/php-laravel" target="_blank">贡献代码</a> 或 <a href="https://github.com/daimingkang/php-laravel/issues" target="_blank">提交 Issue</a>.',
    'be_nice' => '我们希望PL社区能够成为PHP和Laravel技术氛围最好的社区，而实现这个目标，需要我们所有人的共同努力：友善，公平，尊重知识和事实。',
    'publish_typography' => '请注意单词拼写，以及中英文排版',
    ...
    'Congratulations and Welcome!' => '恭喜，您已经成功加入 PL社区，Chrome 用户可使用 <a target="_blank" href="https://chrome.google.com/webstore/detail/fcopfkdgikhodlcjkjdppdfkbhmehdon">PHPHub 插件</a> 实时接收消息提醒。',
