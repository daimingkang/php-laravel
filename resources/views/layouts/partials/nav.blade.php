<div role="navigation" class="navbar navbar-default navbar-static-top topnav" >
  <div class="container">
    ...
    <div id="top-navbar-collapse" class="navbar-collapse" style="background: white">
      <ul class="nav navbar-nav">
        <li class="{{ (Request::is('topics*') && !Request::is('categories*') ? ' active' : '') }}"><a href="{{ route('topics.index') }}">{{ lang('Topics') }}</a></li>
        <li class="{{ Request::is('categories/7') ? ' active' : '' }}"><a href="{{ route('categories.show', [7, 'filter' => 'recent']) }}">PHP教程</a></li>
          <li class="{{ Request::is('categories/8') ? ' active' : '' }}"><a href="{{ route('categories.show', [8, 'filter' => 'recent']) }}">Laravel教程</a></li>
       ...
       {{-- <li class="{{ (Request::is('wiki') ? ' active' : '') }}"><a href="{{ route('wiki') }}">Wiki</a></li>--}}
        <li class="nav-docs"><a href="https://laravel-china.org/docs/home" target="_blank">文档</a></li>
      </ul>
