...
class PagesController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        return redirect()->away('https://www.bing.com/search?q=site:php-laravel.com ' . $query, 301);
    }
    ...
    public function feed()
    {
        ...
        $channel =[
            'title'       => 'PHP Laravel - PHP & Laravel的中文技术社区',
            'description' => 'PHP Laravel是 PHP 和 Laravel 的中文社区，在这里我们讨论技术,问题解决,分享技术。',
            'link'        => url(route('feed')),
        ];
